...
War alles perfekt? Konnte es so weitergehen? Das "`System"', wie Law es nannte, brach in sich zusammen. Die Gewinne wurden nicht wie versprochen f{\"u}r eine Expedition ausgegeben, sondern zur Begleichung der immensen Staatsschulden. Bei einer Abwertung der Papiernoten verlor die Bev{\"o}Leerung endg{\"u}ltig das Vertrauen in jene.
