...
\clearpage
\section{{\"U}ber das Eingreifen des Staates} %% Autor: Gregor May %%
\label{sec4:CaseStudy}
2014, Jahr 7 nach der wohl katastrophalsten Finanzkrise seit dem 2. Weltkrieg. Die Regierungen der gr{\"o}{"s}ten Weltwirtschaftsnationen planen oder f{\"u}hren gro{"s}e Ausgaben zur Rettung der Banken oder damit die Wirtschaft wieder in Schwung kommt, sehr zum Wohlwollen vieler {\"O}konomen. 


Und doch sei angemerkt, dass es eine nicht geringe Anzahl an Kommentaren gab und gibt, die diesen Ma{"s}nahmen kritisch bis ablehnend gegen{\"u}ber stehen. 
Ihre Gr{\"u}nde sind verschiedene, manche tun es aus praktischen, manche aus analytischen und manche aus ideologischen Gr{\"u}nden.

Im Fokus der Debatte steht die von Hayek mit begr{\"u}ndete, sogenannte "`{\"o}sterreichischen Schule"'. Nicht selten hat sie das Argument der mangelnden Effektivit{\"a}t gegen das Eingreifen des Staates in die Wirtschaft geschwungen haben. Von ihrem Standpunkt aus, sollten Individuen ihre eigenen Entscheidungen treffen, der Staat darf nur minimal beeintr{\"a}chtigen.

Ist dieser Standpunkt auch nicht f{\"u}r die vorherrschende, von neomonetaristischer und neokeynes'ianischer Wirtschafts- und Geldpolitik beherrschter {\"O}konomik repr{\"a}sentativ, so ist eine Auseinandersetzung mit ihm notwendig.

Haupts{\"a}chlich handelt es sich hier um eine These, die mit wenig empirischer Belegbarkeit belastbar daherkommt. Jedoch, diese These kann helfen die Aufmerksamkeit darauf zu lenken, wo das Eingreifen der Regierungen katastrophal gescheitert ist. Und weitergehend auch ihr Gegenteil: die Beispiele, wo diese Interventionen funktionierten.
...
oder ist wirklich der Staat kompetenter zu entscheiden, wo und in welcher Form das verf{\"u}gbare Kapital am zweckm{\"a}{"s}igsten zu verwenden ist? \footnote[91]{\citep*[S.23f]{Hayek1969}}
\end{quote}

Schaut man sich die Geschichte der Entwicklung der (Finanz-)M{\"a}rkte seit dem 16. Jahrhundert an, so kann man wieder und wieder ein, ob nun k{\"u}rzlich oder in Vergangenheit eines beobachten: Unregulierte M{\"a}rkte boomen und kollabieren schlie{"s}lich. Die aller ersten M{\"a}rkte reagierten damals mit erzwungener Standarisierung von Gewichten und Ma{"s}einheiten, eine Regulierung, der sich auch Hayek nicht verschloss.\footnote[91]{\citep*[S.28f]{Hayek1969}}
