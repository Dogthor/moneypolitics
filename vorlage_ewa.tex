...
Der Begriff Geldpolitik f{\"u}hrt immer wieder zu Hilflosigkeit, {\"U}berforderung oder falscher Benutzung. Diese Arbeit soll auf das Verst{\"a}ndnis von Geldpolitik erkl{\"a}rend eingehen. Erg{\"a}nzt wird dies, durch die Vorstellung verschiedener geldpolitischer Mittel im Euroraum. Anschlie{"s}end werden die Grundgedanken der {\"O}konomen Milton Friedman, Maynard Keynes und Friedrich von Hayek vorgestellt. Eine  Case Study am Ende soll die Frage kl{\"a}ren, ob ein Eingriff des Staates in die Geldpolitik sinnvoll ist.
...
\subsection{Einblick in die Grundgedanken der Keynesianischen Schule} %% Autor: Marius Hanniske %%
...
\subsection{Einblick in die Grundgedanken der {\"o}sterreichischen Schule (Hayek)} %% Autor: Gregor May %%
